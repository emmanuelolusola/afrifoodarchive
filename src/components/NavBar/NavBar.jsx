...
const NavBar = () => {
  ...
  return (
    <nav className="z-10 py-4 md:py-6 px-[20px] md:px-[150px] fixed w-full top-0 flex justify-between items-center text-base md:text-[24px] text-[#1D1D1F] font-medium bg-[#ffffc5] ">
      <Link to="/">
        <img
          src={logo}
          alt=""
